...
def run_seed_test():
    ...
    Test products include:
        ...
        - Sample prices and stock quantities
    ...
    Use case:
        Quick database seeding for rapid development and testing.
        For production use, use run_seed() instead.
